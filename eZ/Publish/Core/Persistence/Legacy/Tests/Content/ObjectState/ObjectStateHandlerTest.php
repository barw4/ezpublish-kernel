...
class ObjectStateHandlerTest extends LanguageAwareTestCase
{
    ...
    public function testCreateGroup()
    {
        ...
        $mapperMock->expects($this->once())
            ...
            ->willReturn($this->getObjectStateGroupFixture());
    ...
    public function testLoadObjectStates()
    {
        ...
        $mapperMock->expects($this->once())
            ...
            ->with($this->equalTo([[]]))
            ->willReturn([$this->getObjectStateFixture(), $this->getObjectStateFixture()]);
    ...
    public function testCreate()
    {
        ...
        $mapperMock->expects($this->once())
            ...
            ->with($this->equalTo($this->getInputStructFixture()))
            ->willReturn($this->getObjectStateFixture());
    ...
    public function testSetPriority()
    {
        ...
        $mapperMock->expects($this->once())
            ->method('createObjectStateFromData')
            ->with($this->equalTo([[]]))
            ->willReturn(new ObjectState(['id' => 2, 'groupId' => 2]));
    ...
    public function testDelete()
    {
        ...
        $mapperMock->expects($this->once())
            ->method('createObjectStateFromData')
            ->with($this->equalTo([[]]))
            ->willReturn(new ObjectState(['id' => 1, 'groupId' => 2]));
